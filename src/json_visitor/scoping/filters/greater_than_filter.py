...
class GreaterThanFilter( ValueComparisonFilter ):
    """
    Implements a filter which selects a scope where the scope's evaluated value is greater than a literal value.
    """
