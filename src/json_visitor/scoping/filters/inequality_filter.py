...
class InequalityFilter( ValueComparisonFilter ):
    """
    Implements a filter which selects a scope where the scope's evaluated value is not equal to a literal value.
    """
